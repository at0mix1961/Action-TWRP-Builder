...
| `DEVICE_TREE_URL`    | Device address                                    | https://github.com/at0mix1961/twrp_device_WIKO_W_V770       |
| `DEVICE_TREE_BRANCH` | Device branch                                     | android-11                                                 |
| `DEVICE_PATH`        | Device location                                   | device/WIKO/W_V770                                            |
| `DEVICE_NAME`        | Model name                                        | W_V770                                                        |
| `MAKEFILE_NAME`      | Makefile name                                     | twrp_W_V770                                                   |
